...
\header { 
		...
		subtitle = \markup\medium "Znamenny Chant"
                ...
                meter =\markup{ \override #'(font-name . "Thryomanes italic") { Обиходъ Нотнаго Пѣнїя }
                " (Moscow, 1909)" }
		subsubtitle = " "
		tagline = " " 
		}
...
\score{ \transpose g bes 
	...
	a2 g a b4( a a8^-[ b a g] a4 g fis8[ g] a4 g8[ a] g4 fis8[ g] a4 g \Z a a8^-[ g fis g] a4 g 
	\dottedPhrasingSlur e8\( g4 a8\) fis[ g] a4) g4 a2 \J
	g4( a8 b4 a b8 a4) g a2( a4^- b8[ a g] \Z a4. g8 fis[ g] a4 g a8[ g a] b4 a a8^-[ b])
        a([ g]) a2( g4 fis8[ g] a4 g8[ a] g4 fis8[ g]) a4.( b8) \Z 
        a4( g a4. g8 fis[ g] a4 g e8\( g4 a8\) fis[ g] a4 g a2)\breathe \W 
        g4( a8 b4 a b8) a4( g a2 a4^- \Z b8[ a g]) a4( a8^-[ g fis g] a4 g a8[ g a] b4 a8 b4) a8([ g]) 
        a2 a4( g fis8[ g a g] a4 g a) \Z g8([ a]) b4( a g8\( a4.\) g8[ a b c b a] b4 c8[ b])
        a8([ g]) a b2( a4 g8[ a] b4 a) b8([ a g]) \Z a4( g) fis8([ g]) a2( a4^- g8[ a] b4) a g2\breathe \W
        a4( b a g8[ a]) b8.([ a16 g8 a g fis]) g([ a]) b4( a \Z b8[ a g] a4 g fis8[ g] a2 g8)
        g([ fis g a g] a4)  g( a2 g8[ fis g a] b4 c8.[ b16 a8 b a g] a4 \Z g8[ a] b4 a) g8([ a]) 
        b4( a g8\( a4.\) g8[ a b c b a] b4 c8[ b a g a] b2 a4 g8[ a] \Z b4 a a8^-[ b a g] a2 
...
\addlyrics {
	Let __ us who mys -- tic' -- ly re -- pre -- sent __
        ...
        \new Staff {
                ...
                c4( d) d( e d c2 b4 c) e4 d2( e8\( d4.\) \once \override Tie #'extra-offset = #'(0 . -0.5) 
                g2~ g4 d2) c4 c8 d2( c4 e d2) d4. d4( e) fis8([ e])
...
\score{ \transpose g bes 
        ...
        \set Staff.midiInstrument="cello"
                ...
                b4( a g8 a4. g8[ a b c b a] \Z b4 c8[ b a g a] b2 a4 g a2) g\fermata \breathe \W
                ...
                g2(^\markup\bold\italic{ritard.} fis8[ g] fis4 e8[ fis g a] fis4 g a1) \fermata\bar"|."
         }
