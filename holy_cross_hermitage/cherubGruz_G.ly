...
global = {  \key aes \major \set Timing.defaultBarType = ":" \set Staff.midiInstrument = "choir aahs"  } 
firstTenor = \relative c' {   \once \override TextScript #'extra-offset =#'(-9.2 . 0) c2(^\markup{ \italic{gently} \hspace #.5 \raise #.2 \smaller \note #"4" #1 = 65 } des)  ees4.( des8)  f2(~  f4. ees8  ees2)  des4 des des2  ees4 f ees des  c2( des4) c8[( des)] bes2(~ \once\override Tie #'extra-offset = #'(0 . .6) bes~ bes aes bes1)  ees4 ees ees ees8([ des]) f2(~ f4. ees8) ees2( des4) des des2( c) bes4( aes) bes( c) des2 ees4( des8[ ees]) c2. c4 c2( bes4) bes c1  
...
ees2 ees  \fermata \C  ees4. ees8 ees4 ees ees ees ees2~ ees f4( ees) des( ees f2 ees) ees c c4 c ees2( f4) ees des2 f4.( ees8) ees4( c des4 c8[ des] ees1) des4 des des des des2 des4 ees8 f ees4( des8[ ees] c4) bes c1 \breathe f2. ges4 f2 ees ees( f) ges4( f ees2) des4( ees) des2 ees( des c) ees4( des) c2( bes) aes1 \fermata \bar"|."
		}} 
