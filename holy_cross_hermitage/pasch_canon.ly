...
\include "kliros.ly" \header { title =     "The Canon of Holy Pascha" subtitle = \markup   ""
subsubtitle = \markup \center-column { "Being the Work of our Father among the Saints," "John of
Damascus" } tagline = \markup \center-column \teeny { "Hermitage of the Holy Cross + Wayne, WV, USA"
...
\score {
        ...
        \relative c'' { \set Score.timing = ##f \key g \major \autoBeamOff
          ...
          b c d e d8[( c)] b4 c2  b4 c d e d8[( c)] b4
          c2 \Z b4 c d e d8[( c)] d4 c2 b4 a b( c) b a
          g2 b4 c \Z d e d8[( c)] b4 c2 d4 e2\accent d\accent c2. c4 b8[( g)]
          a[( b)] c2. c4 \Z b c b a g2 \bar "||" 

}

\addlyrics { \set fontSize = #-.5  It is Re -- sur -- rec -- tion day. O ye peo -- ples, let us
...
\score { \relative c'' { \set Score.timing = ##f \key g \major \autoBeamOff 
        g4 a b2( a4) c b a g2 \fermata \bar "||"  }
...
\relative c'' { \set Score.timing = ##f \key g \major \autoBeamOff 
         ...
         b4 c d e d8[( c] b4) c2 b4 c d e d8[( c] d4) c2
         \Z b4 a g a  b b a( g) a b c2 b4 b a8[( b)] c4
         \Z b( a) g2. c4 b c d e d8[( c)] b4 c2 d4 e2\accent  \Z d8[( c)] b4
         c2.  c4 b c b a g2 \bar "||" }

\addlyrics { \set fontSize = #-.5  Let us cleanse our sens -- es and we shall be -- hold __ Christ,
...
\relative c'' { \set Score.timing = ##f \key g \major \autoBeamOff 
         ...
         g4 g a b2 b4 b a g a b c2. c4 b c \Z d( e) d8[( c)] b4
         c c b c d( e) d8[( c)] b4 c2 b4 a b c \Z b a g2
         g4( a) b2 a4( b) c2 b4( c) d2. c4 d e d8[( c)] b4 \Z c2 a8[( b)] c4
         b( a) g2 \fermata \bar "||" }

\addlyrics { \set fontSize = #-.5 For it is meet that the heav -- ens should be glad and that the
...
\score { \relative c'' { \set Score.timing = ##f \key g \major \autoBeamOff 
    ...
    b8[( a)] b[( c)] d2 c8[( a)] b[( c)] d4 d( c) b b8[( a)] c4(^\markup{↓E} b) a8[( g)]
    a[( b)] c4 \Z  b( a b c) d2^\markup{↑G} c4 d2 d8[( c)] b4 c d2 c8[( d)] e4 d8[( c b
    c)] \Z d4 c b2 b4 b8[( a)] c8[( d] e4 d) d8[( c)] d4( c) b2^\markup{↓E} g8[( a)] b4(
    c8[ b] a4 b) \Z a2(^\markup{↓D} g4) g( a) b2^\markup{↑G} b8[( c)] d4 c( b) a8[( g)] a[( b)] c4
    b2.^\markup{↓E} b4 a1^\markup{↑A} \fermata \bar "|." 

}

\addlyrics { \set fontSize = #-.5 It is Re -- sur -- rec -- tion day, __  O ye __ peo -- ples, let
...
\score { \relative c'' { \set Score.timing = ##f \key g \major \autoBeamOff 
        ...
        b2 b4 b a g a( b) c2. c4 b c d e d8[( c)] b4 c2
        \Z b4( a) b c b a g2

        g4 a b b a b c c b c d e \Z d8[( c)] b4 c2 

        b4 b b a8[( b)] c4 b( a) g2 \bar "||" 
...
\score { \relative c'' { \set Score.timing = ##f \key g \major \autoBeamOff 
        ...
        b4 c d e d8[( c)] b4 c2 e4 d8[( c)] b4 c2 b4 b b b b \Z
        a8[( b)] c4 b a g2 

        g4 g a b2. b4 a g a b c2. c4 b c \Z d( e) d8[( c)] b4 c2.
        b4 b b a8[( b)] c4 b( a) g2  \bar "||" }
...
\score { \relative c'' { \set Score.timing = ##f \key g \major \autoBeamOff
        ...
        b4 b a b c2 b4 c d( e) d8[( c)] b4 c2 b4 c \Z
        d( e) d8[( c)] b4 c b a8[( b)] c4 b( a) g2 

        b2 a4( b) c2 b4 c \Z d e d8[( c)] b4 c2 b4 c d e
        d8[( c)] b4 c c b a b b \Z a8[( b)] c4 b( a) g2
        \fermata \bar "|."

    }

\addlyrics { \set fontSize = #-.5 Yest -- er -- day, O Christ, I was bur -- ied with Thee, and to --
...
\score { \relative  c'' { \set Score.timing = ##f \key g \major \autoBeamOff
    ...
    g4( a) b2 b4 a b8[( a)] b[( c)] d4( c8[ b]) a2  

    g4( a8[ b]) c4 c \Z c8[( a)] b[( c)] d4 d d8([ c] b4) c2 c4 c b a b2^\markup{↓E}

    a4 b8[( c)] \Z d4^\markup{↑G} d8[( c)] b4 c d2 c8[( d)] e4 d8[( c)] b[(
    a)] b[( c)] d4 c8[( b)] a4( b c) \Z

    d4( c8[ b]) c4(^\markup{↓E} b) a8[( g)] a[( b)] c4 b2 a1^\markup{↑A} \fermata \bar
    "|."  
...
\context ChoirStaff  <<
        ...
        \context  Voice = tenor { \set Staff.midiInstrument = "cello" \set Score.timing = ##f
    ...
    \context Voice = bass { \set Staff.midiInstrument = "cello" \set Score.timing = ##f  \key d
...
\score { \relative c'' { \set Score.timing = ##f \key g \major \autoBeamOff 
    ...
    g4 a b2. b4 a g a b c2. b4 c d( e) d8[( c)] b4 c2 \Z
    b4 c d e d2 d8[( c)] b4 c2 b4( a) b c b a g 

    g g a \Z b2 b4 b a( g) a b c2. b4 b b b b a8[( b)] c4
    b a g2. \bar "||" 
...
\score { \relative c'' { \set Score.timing = ##f \key g \major \autoBeamOff 
    ...
    b4 c d e d8[( c)] b4 c2 b4 a g a b8[( g)] a[( b)] c2
    \Z b4 c  d e d8[( c)] b4 c2 b4( a) b c b a g 

    g g a \Z b b a b c2. c4 b a b b a8[( b)] c4 b( a) g2

    b4 c d2 c2 \Z  b2 a8[( b)] c4 b a g2
...
\score { \relative c'' { \set Score.timing = ##f \key g \major \autoBeamOff 
    ...
    b4 b a b c2 b4 c d e d8[( c)] b4 c2 b4 a \Z
    g a b8[( g)] a[( b)] c4 c b c d e d8[( c)] b4 c2  b4 b b b \Z
    a8[( b)] c4 b a g2

    b4 c d2 d8[( c)] b4 c2. c4 b( g) a b \Z c c b b
    a8[( b)] c4 b a g2 
...
\score { \relative c'' { \set Score.timing = ##f \key g \major \autoBeamOff 
        ...
        b2 b4 b a g a b c2 b4 c d e d8[( c)] b4  c2 b4 a
        \Z b c b a g2

        g4 a b2. b4 a g a b c2 c2. c4 d e \Z d8[( c)] b4 c c b a
        g a b8[( g)] a[( b)] c2 b4 c d e d8[( c)] b4 \Z
        c2.

        b4 b b b b a8[( b)] c4 b a g2 \fermata 
...
\score { \relative c'' { \set Score.timing = ##f \key g \major \autoBeamOff 
        ...
        b4 b8[( d)] b4 a8[( b)] c[( b)] a4 b a8[( b)] a2^\markup{↓D}

        g4 a b4.( a8) g4 a b2^\markup{↑G} \Z

        b8[( a)] b[( c)] d4( c) b8[( a)] b([ c] d4. c8) b4 b8[( c)] d4( c) b2^\markup{↓E}

        b4 b8[( g)] \Z c8[(^\markup{↑A} d c b)] a4( b8[ c]) d2 

        d4( c) b2 a4 c( b8[ a]) b[( c)] d4 d2 c4( d) c( b) \Z c2 b4( a)
...
\score { \relative c'' { \set Score.timing = ##f \key g \major \autoBeamOff 
        ...
        c4 b a g2 a4 g a( b) c2. c4 b c d e d8[( c)] b4 \Z
        c2. b4 a b c b a g2

        g4 b g a( b) c2. c4 d e \Z d8[( c)] b4 c2.

        b4 b b a8[( b)] c4 b a g2 
...
\score { \relative c'' { \set Score.timing = ##f \key g \major \autoBeamOff 
        ...
        g4 g a b2. b4 a g a b c2 c2. c4 b c \Z d( e) d8[( c)] b4
        c2 b4 a b c b a g2

        g4 a b b a b \Z c2. b4 b b b b a8[( b)] c4 b( a)
        g2	
...
\score { \relative c'' { \set Score.timing = ##f \key g \major \autoBeamOff 
        ...
        b4 a g2. g4 g g a g a( b) c2. b4 b a b( c) b a \Z b2
        a8[( b)] c4 b( a) g2 

        c4 b a g a b b a( g) a( b) \Z c2 b4 a g a b8[( g)] a[( b)]
        c2 b4( a) b( c) b a g2 \fermata
...
\score { \relative c'' { \set Score.timing = ##f \key g \major \autoBeamOff 
        ...
        a2 g4 a b2 c4 c8[( a)] b[( c] d4) c2 c4 c8[( a)] b[( c)] 

        d4 d8[( c)] \Z b4 c d2 d4 d d8[( c)] b[( c)] d4 c b2^\markup{↓E} c8[( d)] e4^\markup{↑B}
        d8[( c)] 

        d4( c) b2 b4 \Z a4^\markup{A~un.} g8[( fis)] g[(^\markup{↓E} a)] b[(
        a)] b4 b8[( c)] d4^\markup{↑G} 

        c8[( b)] c4( b) a8[( g)] a[( b)] c4 b2( a1) \fermata 
...
\score { \relative c'' { \set Score.timing = ##f \key g \major \autoBeamOff
    ...
    c4 b c d e d8[( c)] b4 a b c8([ d] e4) d8[( c)] b4 c2 \Z b4 a
    g2 g4 a b g a b c2. c4 b c d( e) d8[( c)] b4 \Z c4 c b a
    b( c) d8[( c)] b4 c2. c4 b a8[( b)] c2. b4 b b \Z
    a8([ b] c4) b a g2.
...
\score { \relative c'' { \set Score.timing = ##f \key g \major \autoBeamOff 
        ...
        g4 a b b a b c2 b4 c c8[( d] e4) d8[( c)] b4 c c \Z b a g a
        b8[( g)] a[( b)] c2 b4 a b c b a g c \Z b c d e d8[( c)] b4
        c b a8[( b)] c4 b a g2 	
...
\score { \relative c'' { \set Score.timing = ##f \key g \major \autoBeamOff 
        ...
        g4 a b2 a4 b c2 b4 c d e d8[( c)] b4 c2 b4 a \Z
        g2 g4 a b( g) a b c2 b4 c d e d8[( c)] b4 c b \Z
        a8[( b)] c4 b( a) g2 \J g4 a b b a b c2 b4 c d(
        e) \Z d8[( c)] b4 c2 b4 a b c b a g2 \fermata \bar "||" 
...
\relative c' { \set Score.timing = ##f \key f \major \autoBeamOff \set Staff.midiInstrument =
"cello"

    f4 f e4 f g2 g4 g f g g( a) a g a2 \W bes4 a a a a
    \Z g2. g4 f2 \fermata \W f4 f f e f g( a) a a2. a4 a
    a g2 g4 g f2 \fermata \W f4 e f  g g f g g( a) a2
    \fermata \W c2 bes4( c bes a2) \fermata \W f4( g) a a g \Z bes( a) g8[( a)] bes4 a a g( a) a a
    bes a a a bes a g2 f2 \fermata \W f4 e f g g g g g f
    g( a) a2 \J g8[( a)] bes4 a a a g2( f2) \fermata \W
    g2 g4 g f g( a) a g f( g) a2 \J a4 g bes a a a a a g2 \Z g4 g
    f2 \fermata \W f4 f f e f g g g f g a g2 \J g4 f g \Z g( a) a
    a2 \J a4 a g bes( a) a g2. g4 f2 \fermata \W c'4 c2( bes4 a
    g) f  \Z \override Staff.SeparationItem #'padding = #.5 g8[( a] bes4) a2
    \J \noBreak f4 g a a a a8[( g)] f4 f f g( a bes8[ a] g4) a1 \fermata \bar
    "|."
...
\score { \relative c'' { \set Score.timing = ##f \key g \major \autoBeamOff 
        ...
        g4 g a b b a b c2 b4 c c( d) d8[( c)] b4 c2 b4 a \Z g a b b a g a8[(
        b)] c4 b( a) g2 b4 g a b c2 \Z b4 a b8[( c)] d4 d8[( c)]
        b[( c)] d4 c b a g a b b \Z a g a b c2 b4 b b b
        b a8[( b)] c4 b( a) g2 		
...
\score { \relative c'' { \set Score.timing = ##f \key g \major \autoBeamOff 
        ...
        g4 b b a b c c b a b8[( c)] d4 d8[( c)] b4 c2.
        b8[( a)] \Z g2 a4 b a g a b c2. b8[( c)] d4. d8 d[( c)] b[(
        c)]  d4( c) \Z b b8[( c)] b4 a g2 g4  a b b b b a( g) a b
        c2. b8[( c)] \Z d2 d4 c b a b2 a8[( b)] c4 b( a)
        g2 
...
\score { \relative c'' { \set Score.timing = ##f \key g \major \autoBeamOff 
            ...
            g8[( a)] b2. b4 a g a b c2 b8[( c)] d4 c4.( b8)
            a[( b)] c4 b( a) \Z g2 g4 a b b a b c c b c
            d e d8[( c)] b4 c2 b4 a \Z g a b b a g a b
            c2. c4 b c d e d8[( c)] b4 \Z c2 b4 a b2
            a8[( b)] c4 b( a) g2	\fermata
...
\score { \relative c'' { \set Score.timing = ##f \key g \major \autoBeamOff 
    ...
    d2 b4( c) d2 c2. b4 a g2. a4 b g a b c2. c4 \Z d8[(
    c)] b[( c)] d4 d c2 b4 a g a b b a( g) a b \Z c2 b4 b
    a8[( b)] c4 b4( a) g2. c4 b c d e d8[( c)] b4 \Z c2 b4 a
    g( a) b2  a4 g a8[( b] c4) b a g2 \fermata	
...
\score { \relative c'' { \set Score.timing = ##f \key g \major \autoBeamOff 
    ...
    d4 c( b) b8[( a)] c4( b) a8[( g)] a[( b)] c4 b2 c4 b
    a( d) d8[( c)] b4 \Z c2 b b4 b8[( a)] b[( c)] d4 d8[( c)] b4( c) d2
    a4 d d( c b c) d2 \Z d4 c8[( d)] e4 d8[( c)] b2 b4 b8[( a)] c4( b) a8[(
...
\score{ \relative c'' { \set Score.timing = ##f \key g \major \autoBeamOff 
    ...
    b4( c) d2 d4 e d8[( c)] b4 c2 b4 a g( a) b8[( g)] a[( b)]
    c2 \Z b4 c d2 c4( b) c2 b4 a b a g2 g4 a b b a b \Z
    c c b( c) d e d8[( c)] b4 c b a8[( b)] c4 b( a) g2
...
\score{ \relative c'' { \set Score.timing = ##f \key g \major \autoBeamOff 
    ...
    b2. b4 a g a b c2 b4 b a8[( b)] c4 b( a)
    g2. g4 g a \Z b2 a4 g a( b) c2  b4 c d2 c4 b a( c)
    b( a) g2. g4 \Z g a b2 a4 b c2 d4 e d8[( c)] b4 c b
    a8[( b)] c4 b4( a) g2
...
\score{ \relative c'' { \set Score.timing = ##f \key g \major \autoBeamOff 
    ...
    g4 a b b b b a( g) a b c2 c2. b4 c \Z d e d8[( c)] b4
    c2 b4 a b c b a g2 g4 a b b a b \Z c2 b4 c d e d8[( c)] b4
    c c b c d e d8[( c)] b4  \Z c2 b4 b b b b b a8[( b)]
    c4 b( a) g2 
...
\score { \relative c'' { \set Score.timing = ##f \key g \major \autoBeamOff 
        ...
        g4 g g a b b a b c2( b4 a) b( c) b a g2 \bar "||" }
...
\score{ \relative c'' { \set Score.timing = ##f \key g \major \autoBeamOff 
    ...
    g4 b2 a4 b c2 b4 c d( e) d8[( c)] b4 c2 b4 a
    g( a) b8[( g)] a[( b)] \Z c2 b4 a b c b a g2 b4 b a b
    c c b c d( e) \Z d8[( c)] b4 c2 b4 a g a b8[( g)]
    a[( b)]  c2 b4 c d( e) d8[( c)] b4 \Z c b a8[( b)] c4
    b( a) g2  \fermata
...
\score{ \relative c'' { \set Score.timing = ##f \key g \major \autoBeamOff 
    ...
    b2 b4 b8[( a)] b[( c)] d4 c8[( b)] c4( b) a8[( g)] a[( b)] c4.( b8) a[( b)] c4 b2 \Z
...
\score{ \relative c'' { \set Score.timing = ##f \key g \major \autoBeamOff 
      ...
      b4( c) d4 d d e d8[( c)] b4 c2 b4 c d e d8[( c)] d4
      c2 \Z b4 a b c b a g2 d' e d8[( c)] b4 a8[( b)] c[( b)] a2
      g \Z e'4 e d2. c4 d2 c b8[( c)] d4( c8[ b]) c2. g4 g a b b b \Z a8[( b)]
      c[( b)] a4 a4 g2 \fermata		
...
\score{ \relative c'' { \set Score.timing = ##f \key g \major \autoBeamOff 
        ...
        d4 c d8[( e f e)] d[( c)] b4 c2 d4 c d8[( e)] f![( e)] d8[( c)] d4 c2 \Z c4 b8[(
        c)] d2 c c4 b8[( c)] d4( c8[ b]) a[( b)] c[( d)] c4 b8[( a)] b[( c)]
        b4( a) g2 \fermata 
...
\score{ \relative c'' { \set Score.timing = ##f \key g \major \autoBeamOff 
        ...
        d2 d4 c d8[( e f e)] d4( b) c2 b8[( c)] d4 c8[( b)] a[( b)] c[( d)] c2 c4 \Z c b
        d2( c) b\breve a8[( b] c4) b a g2 \fermata 
...
\score{ \relative c'' { \set Score.timing = ##f \key g \major \autoBeamOff 
        ...
        b8[( c)] d4.( c8 b4) c d4.( c8) d4 e d2 d4 c d8[( e f e] d[ c)] b4 c2 \Z c4  b8[(
        c)] d4( c8[ b]) a[( b)] c[( d)] c2  d4 c d8[( e)] f![( e)] d[( c)] d4 c2  d4 c \Z d8[( e)]
        f![( e)] d4 c8[( b)] a[( b)] c[( d)] c4 c b8[( c)] d2 c d8[( c)] d[(
        e)] f![( e)] \Z d[( c)] b4 c2 b4 b b a8[( b)] c4 b( a) g2 \fermata 		
...
\score{ \relative c'' { \set Score.timing = ##f \key g \major \autoBeamOff 
        ...
        b4 c d d d c d8[( e f e)] d[( c)] b4 c2 d8[( c)] d[( e)] f![( e)] \Z d([ c] d4)
        c2 d4 c8[( b)] a[( b)] c[( d)] c4 b b b a8[( b)] c4
        b( a) g2 \fermata 
...
\score{ \relative c'' { \set Score.timing = ##f \key g \major \autoBeamOff 
        ...
        g4 g a b2 a4 b c c b c d e d8[( c)] b4 c2
        b4 \Z a g a b c c b a b8[( c)] d4 d8[( c)] b[( c)] d4( c)
        b4 b8[( c)] \Z b4 a g2. c4 b a g2 g4 a b( g) a b c2 c4 b \Z a8[( b c
        b)] a4 a g2 \fermata
...
\score{ \relative c'' { \set Score.timing = ##f \key g \major \autoBeamOff 
        ...
        d2. c4 d8[( e f e] d[ c]) b4 c2 d4( c) d8[( e)] f![( e)] d[( c)] b4 c2 d4 c8[(
        b)] \Z a[( b)] c[( d)] c2 b\breve a8[( b)] c4 b(
        a) g2 \fermata
...
\score{ \relative c'' { \set Score.timing = ##f \key g \major \autoBeamOff 
        ...
        b8[( c)] d4. c8 b4 c d4.( c8) d[( e)] f[( e)] d[( c)] b[( c)] d4  c8[( b)] \Z
        a[( b)] c[( d)] c4 b8[( c)] b4( a) g2
...
\score{ \relative c'' { \set Score.timing = ##f \key g \major \autoBeamOff 
        ...
        b4 c d2. c4 d8[( e)] f[( e)] d[( c] b4) c2 b8[( c)] d4 c8[( b)] a[(
        b)] c[( d)] \Z c2 b4 b b a8[( b)] c4 b( a) g2 \fermata
...
\score{ \relative c'' { \set Score.timing = ##f \key g \major \autoBeamOff 
    ...
    b8[( c)] d2 d4 c d8[( e f e)] d[( c)] b4 c b a8[( b)] c[( d)]
    c2. c4 c b8[( c)] \Z d2 c2. b4 b b a8[( b)] c4 \stemUp b( a g2)
    \fermata
...
\score{ \relative c'' { \set Score.timing = ##f \key g \major \autoBeamOff 
    ...
    b8[( c)] d2 d4 c d e d8[( c)] b4 c2. b8[( c)] d2 d8[( c)] b[(
    c)] \Z d4( c) b4 a8[( b c b)] a4 a g2 b4 b b b a( g) a b c2 c2.
    c4 \Z b c d( e d8[ c]) b4 c( b) a8[( b)] c4 b( a) g2 \fermata	
...
\score{ \relative c'' { \set Score.timing = ##f \key g \major \autoBeamOff 
    ...
    b8[( c)] d2. c4  b c d2. c4 d( e) d c8[( b)] a[( b)] c[( d)]
    d[( e)] f[( e)] \Z d([ c] b4) c2 b\breve a8[( b)] c4 b( a) g2
    \fermata
...
\score{ \relative c'' { \set Score.timing = ##f \key g \major \autoBeamOff 
    ...
    d4.( c8 b4) c d4.( c8) d4 e d2 d4 c d8[( e)] f[( e)] d[( c)] b4 c c b8[( c)] \Z d2 c4
    b b b b a8[( b)] c4 b( a) g2 \fermata
...
\score{ \relative c'' { \set Score.timing = ##f \key g \major \autoBeamOff 
    ...
    b8[( c)] d4.( c8 b4) c d4.( c8) d4 e d2 d8[( c)] d[( e)] f![( e)] d[( c)] b4 \Z c2.
    d4 d d8[( c)] d[( e)] f![( e)] d[( c] d4) c2 c4 c c b8[( c)] d4 c8[( b)] a[( b)] c[(
    d)] \Z c4 b8[( a)] b[( c)] b4( a) g2 \fermata	
...
\score{ \relative c'' { \set Score.timing = ##f \key g \major \autoBeamOff 
    ...
    d4.( c8 b4) c4 d4.( c8) d4 e d2 d4 c d8[( e f e)] d[( c)] b4 c2 \Z c4 b8[(
    c)] d4( c8[ b)] a[( b)] c[( d)] c4 b8[( a)] b[( c)] b4( a) g2
    \fermata 
...
\score{ \relative c'' { \set Score.timing = ##f \key g \major \autoBeamOff 
    ...
    a4( b2~ b8[ a b c]) d2( c) d4 d c d d c2 d4 d8[( c)] \Z d4 d8[( c)] b4 c
    d2 d4 c b a8[( b)] c4 b( a) b2 \Z d2( c4) b b b8[( a)] c4( b) a8[( g)] a[(
    b] c4 b2) a a4 a b2 a4 b2 \Z b8[( a)] b[( c]) d4( c8[ b] a4) b2
    b4 b8[( a)] b[( c)] d2 c4 b a2 a8[( g)] \Z a[( b)] c4 b2(
    a1) \fermata  
