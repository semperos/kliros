...
\score 
{
	\context ChoirStaff <<
		\context Staff = top \transpose c a <<
			...
			{ \voiceOne  \global
                \set Staff.midiInstrument = "cello"
                        ...
                        c8([ des]) ees4 ees8([ des]) \Z 
                        << 
                                { ees([ f ees des]) c([ des]) ees4 }
                                { s8([ des c bes]) s([ bes]) c4 }
                           >>
                                <des bes>( <c aes>) bes2 aes2 \W
                        bes4 c8([ des]) ees4 des c c des8([ c]) bes([ c]) des4 c2( bes) \J \break
                        bes4 c8([ des]) ees4 ees8([ des])
                        % ^ Ne razdel ....
			...
			{ \voiceTwo \global
                         ...
                         f4 f f aes g aes2 aes4 aes f2( g!2) aes 
		...
		\context Staff = bottom \transpose c a, << 
                        ...
                        bes4 bes bes <aes ees'> <bes ees> <c ees>2 <des ees>4 ees des2( ees4 des) c2
			...
			{ \clef "bass" \global \voiceTwo
                \set Staff.midiInstrument = "cello"
                        ...
                        des4 des ees8([ des]) c4 ees <aes aes,>2 <aes bes,>4 <aes aes,> <bes~ bes,>2( <bes ees,>) f \W
                        ges4 f aes2. ees4 <aes aes,>2. <aes aes,>2( ees) \J 
                        g4( aes8[ bes]) c4 des c bes aes <aes ees> <aes aes,>2 <aes aes,>4 <aes aes,> 
                                <aes aes,>2( ees4) ees f2 \W
                        <aes, aes'> <aes aes'> 
                        <<
