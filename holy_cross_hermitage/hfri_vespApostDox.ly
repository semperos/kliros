...
\header { dedication="Holy and Great Friday"
        ...
        composer = "Adapted for English by"
...
\score {
	\relative c 
	  { \clef "G_8" \global  
        d2 e8([ f g a] g[ f e f] e4. d8) f4( g) a2( g8[ a] bes4 a2) a 
        a8([ bes a g] g4. f8 g[ f e d]) \Z f([ g] a4) a8([ bes]) a([ g]) 
        g4.( f8 g[ f e d] e[ f g a]) g([ f e f]) d4.( e8 f4 g) 
        a2 d,4( a') a8([ bes] c4) \Z 
        bes8([ a bes c d c]) bes([ c]) a4( g8[ f g a] bes4) a2
        e8([ f e d]) e([ f g a]) g([ f]) e([ f]) d4.( e8 f4 g) \Z 
        a2 d,4( a') a8([ bes] c4 bes8[ a bes c d c]) bes([ c]) a2 a 
        bes2 a4.( bes8) c4.( bes8) a4( g8[ f]) \Z g([ a] bes4) a4.( g8 a[ g] f4)
        e4.( d8) f4( g) a2( g8[ a bes a]) c([ bes a bes]) a4( g8[ f]) g([ a]) bes4 a2 \Z g4.( f8 g[ f e d])
        f8([ g] a4) a8([ bes a g]) g4.( f8 g[ f]) e([ d]) e([ f g a] g[ f e f]) d2\fermata \W\break
        d2( e c d4 e f g a2 g8[ a] bes4 a2 c8[ bes a bes] a2 e4. d8 g4 f e d \Z g f e d8[ e16 d] c2) \breathe \W
        c'2( c8[ d]) c([ bes]) a2 a4.( g8) a([ bes a g] a4 bes c2) bes4( a) \Z bes( c8[ bes] a4. g8 a[ g] f4)
        e4.( d8) f4( g) a2( c8[ bes]) a([ bes]) a4( g8[ f g a]) bes4 a4( g8[ f g a]) \Z bes4 a g8([ f])
        g4.( f8 g[ f e d]) f([ g] a4) a8([ bes a g]) g4.( f8 e[ f]) e([ d]) e([ f g a]) \Z g([ f]) e([ f])
        d4.( e8 f4 g) a2 a8([ bes]) a([ g]) g4.( f8 g[ f]) e([ d]) e([ f g a] g[ f e f]) \Z d4.( e8 f4 g)
        a2 d,4( a') a8([ bes] c4 bes8[ a bes c]) d([ c bes c] a4 bes) g( a8[ bes]) 
        c4( a \Z bes c c8[ bes a bes] a4. bes8) c2 a8([ bes c bes]) c2( a8[ bes c bes]) c2 c a8([ bes c bes]) c2 \Z
        c8([ bes] d4) a4( bes8[ c] d4 a bes c c8[ bes]) a([ bes]) a4.( g8 a[ g] f4) e4.( d8)
        f4( g) a2 \Z g8([ a bes a]) c([ bes a bes]) a2 a4( g8[ f]) g([ a]) bes4 a2 
        g8([ a] bes4) a4.( g8) g4.( f8) g([ f e d]) \Z e([ f g a]) g([ f]) e([ f])
        d2\fermata\W
        d2( e c d4 e f g a2 g8[ a] bes4 a2 c8[ bes a bes] \Z a2 e4. d8 g4 f e d g f e d8[ e16 d] c2) \breathe \W
        c'4.( bes8 c[ d c bes] a2) a4.( g8) \Z a([ bes a g]) a4 bes c2 bes4( a) bes( c8[ bes]) a2 \W
        d2 d8([ ees d c] ees[ d c bes] a[ bes c bes] c2) \Z a8([ bes c bes]) c2 a8([ bes c bes]) c2 
        c8([ bes]) d4 a4( bes8[ c] d4 a bes c c8[ bes a bes] a4. g8 \Z a[ g] f4 e4. d8) f4( g) a2 
        c8([ bes a bes] a2) a4( g8[ f]) g([ a] bes4) a2 g8([ a] bes4) a2 \Z g4.( f8) g([ f e d f g] a4) a8([ bes a g])
        g4.( f8) g([ f e d] e[ f g a] g[ f e f]) \Z d4.( e8 f4 g) 
        a2 a8([ g a bes] c[ bes a bes]) a4( bes8[ c]) d4( c8[ bes]) a4( g8[ f]) g([ a]) bes4 a2 \Z a g8([ a] bes4) a2
        g4.( f8 g[ f e d]) f([ g] a4) a8([ bes a g]) g4.( f8 g[ f]) e([ d]) e([ f g a]) \Z g([ f]) e([ f]) d4.( e8 f4 g)
        a2 a8([ bes]) a([ g]) g4.( f8) g([ a g f]) e4.( d8 e[ f g a g f]) e([ f]) \Z d4.( e8 f4 g) 
        a2 a8([ bes c bes] c2) a8([ bes c bes]) c2 c a4( bes8[ c]) d4( a bes c) c8([ bes a bes] \Z a4. g8) a([ g]) f4
        e4.( d8) f4 g a2( g8[ a] bes4 c8[ bes a bes]) a4( g8[ f]) g([ a]) bes4 a2 \J
        g8([ a] bes4) \Z a2( g4 a8[ g]) f([ e f g] a[ g a bes] c4 bes8[ a] g4 a g) f8([ g]) a([ g f g]) \Z
        a2( bes4. a8 g4 a bes a8[ bes c bes a g] a1)\fermata\bar"|."
		...
		\addlyrics{
              ...
              cry -- ing out: O __ Lord, __ glot -- ry __ to __ Thee. __
				}
