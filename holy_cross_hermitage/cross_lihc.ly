...
\header {
        ...
        subtitle = "Stichera on “Lord, I have Cried”"
        title = "Exaltation of the Holy Cross"
        composer = "Znamenny Chant"
        poet="Tone VI"
        meter = \markup{ \italic{ Podoben: } " Having Set Aside" }
...
% Sticheron 1
\markup\pad-around #2 \raise #-4 {Sticheron I}
\score {
    \relative c
    { \global \clef "G_8"
        ...
        f4 g a bes bes bes bes8([ a]) \Z bes([ c bes a g]) 
...
\score {
	...
	bes4 a bes c2 bes4 a8([ g]) a[( bes]) c4 a2.( bes4) c bes a2 g8([ a]) \Z bes4( a) g2 \J 
        a4( bes) c( bes) a g8([ a]) bes4 a g2 f4 g8([ a]) bes4 a2 \W
	f4 g \Z a2 g4( a) g4. f8 e4 f g2 a4 bes2 bes8([ a]) 
        bes[( c bes a g a]) bes4( a g f2 g \Z a) g1\fermata\bar"|." 
    }
