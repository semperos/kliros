...
\score {
	\relative c 
	{ \defaults 
	 f4( g) a2 a4 g8([ a]) bes2( a4) a g a2 a4 g8([ f]) a4( g) \dottedPhrasingSlur f2.\(
	 f8\)([ g]) a4 a a g8([ a]) \Z bes4 a8([ g]) a2 \J a4 a8([ g]) a4 a8([ bes]) c([ bes a bes]) a2\(  
	 f8\)([ g]) a4 a a g8([ f]) g4( f8[ e]) d2 \W
	 d4( e) \Z f( e) f( g) f8([ g]) a([ g]) a2 \J
	 bes4 a g f g8([ f] g4) g g f2 \W
	 f4 g a2 a \Z a4 a a g8([ a]) bes4( a8[ g]) a2\( bes8\)([ c]) c([ bes]) a2 \W
	 f4 g a a a g8([ a]) bes4( a8[ g]) a4 g8([ f]) \Z g([ a]) a([ g]) f2\fermata \bar "|."
