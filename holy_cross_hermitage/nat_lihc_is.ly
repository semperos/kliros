...
\score {
        \relative c'
        { \global \override TextScript #'color = #(rgb-color 0.8 0.1 0)
                g8([^\markup{G} a]) bes4 bes bes bes8([ a]) bes([ c bes a]) g4 a8([ bes]) c2^\markup{F} \J
                d4 d c bes8([ c]) d4 d8([ c]) bes4 a g2^\markup{G} \J
                a4^\markup{Un.} g8([ f]) g([^\markup{G} a]) bes2 bes4 bes a( bes8[ a]) g4 g8([ a]) bes4 bes 
                        a^\markup{F} ( g f g8[ a]) g2^\markup{G} \W
                c4^\markup{A} bes^\markup{G} bes8([ c]) d4.(^\markup{F} c8) \Z bes4 a g2^\markup{G} \J
                g8([ a]) bes2 bes4 bes8([ a]) bes([ c]) bes([ a]) g4 g8([ a]) bes4.( a8 g4) bes a( g) g8([ a]) 
                bes4 bes bes \Z bes8([ c]) bes([ a]) g([ a]) bes([ c]) bes4.( g8 a[_\markup{F} bes]) c4 bes2^\markup{ \hspace #-2 ↑B \raise #.5 \flat} \J
                bes8([ c]) d4( c) bes^\markup{Un.} bes8([ a]) g([ bes a g]) f4^\markup{~F} a8([ bes]) c2 \J
                bes8([^\markup{F-} c])^\markup{A} \Z d4^\markup{G} c bes bes8([ a]) c4(^\markup{F} bes a) g2^\markup{↑Un.} f \W
                g4 g8([ f]) g([^\markup{~G} a]) bes4 bes8([ a]) bes([ c]) d4^\markup{B \raise #.5 \flat} c2^\markup{F} \J
                bes8([ c]) d2 c4 bes8([ c]) \Z d4 d8([ c]) bes4 a g2^\markup{G} \J
                g4^\markup{Un.} g8([ f]) g([^\markup{~G} a]) bes4 a( g) g8([ a]) bes4 a(^\markup{F} g f g8[ a]) g2^\markup{G} \J
                c8([^\markup{F} bes]) c([ d]) ees4^\markup{E\raise #.5 \flat} \Z 
                d(^\markup{B \raise #.5 \flat} c)^\markup{F} c8([ d]) ees4 d( c) bes bes8([ a]) bes([ c]) bes([ a]) g4( a8[ bes]) c2 \J
                ...
                c8([ d]) ees4( d) c c8([ bes]) \Z c4.( bes8 a4 \leftBracket bes c d c bes c2 d8[ bes c d] ees4 
                        ...
                        c4. d8 c4 bes \rightBracket bes8--[ a g f g a] bes[ a g] a2 a4-- g) f( g8[ a]) g2 \W
                ...
                { O __ come, let us re -- joice __ in the Lord,
                        ...
                        The __ cher -- ub with -- draw -- eth __ from the __ gate __ of life
                        and __ I par -- take of __ the __ food of __ par -- a -- dise
                        from whence __ I was __ driv -- en a -- way be -- cause of dis -- o -- be -- di -- ence.
                        ...
                        To Him __ let us __ cry __ a -- loud:
...
\score {
        ...
        { \global  
                ...
                \addlyrics
                {
                        ...
                        Ev' -- ry crea -- ture that hath breath __ prais -- eth Thee, the im -- age of the __ glo -- ry
                        of __ the Fa -- ther.
                        O Thou Who art and ev -- er shalt be, O our God who hast shone forth from the Vir -- gin,
                        have mer -- cy on us.
