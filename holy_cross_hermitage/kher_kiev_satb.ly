...
\header {
                ...
                arranger = "гарм. Монаха Пантелеимонa"
...
\score 
{
	\context ChoirStaff <<\transpose  ees c'
		\context Staff = top << 
			\context Voice = firstTenor \relative c'
			{ \voiceOne  \global \tempo 4=65 
                                ...
                                \cadenzaOff \bar "|" }
                                bes2 c des des4( c) bes( c) des bes \cadenzaOn c2^\markup\circle\number{6} c2 bes \cadenzaOff \bar"|"
			...
			{ \voiceTwo \global
                              \repeat unfold 2 
                                ...
                                g aes bes( f g4 aes aes) aes aes2 g 
                                g2 aes4( bes) aes2.( g4 ees4 f ges2 aes4) g! aes2 aes4( g8[ f]) g2
		...
		\context Staff = bottom \transpose ees c 
                        <<

                        \context Voice = tenor \relative c'
                        { \global \voiceOne
                               bes2 bes bes1( ees2 bes4) bes bes2 bes
                               bes2 bes bes1( ees2 bes4) bes bes2 bes

                               ees2 ees4( f) f4( ees des2 ees2 f4) f ees2 ees 
                               ees2 ees2~( ees1~ ees1 f4) f f2 c ees2
                               ees2( f4) ees4 ees2. ees4 ees( d!) c2 bes
			...
			{ \clef "bass" \global \voiceTwo
                              \repeat unfold 2 
                                ...
                                ees2 ees4( des) c2( bes aes1~ aes4) bes f'2 f ees
                                ees2( bes4) bes c4( d! ees) bes bes2 aes4( c) ees2\fermata d2\rest
