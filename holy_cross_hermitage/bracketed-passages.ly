% The below, invented by Mats Bengtsson, creates left and right brackets vertically spanning an entire staff. It is useful for offseting optional passages of music, as shown in the example
% The number next to "th" in (th .2) controls thickness of the brackets. 
