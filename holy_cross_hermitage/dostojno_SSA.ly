...
\header {
  ...
  composer="Монаха Пантелеимона"
  arranger= \markup\italic "Перелож. для Женского Хора"
  tagline = " "
...
\score 
{
	\context ChoirStaff <<
		\context Staff = top <<
			...
			{ \voiceOne \global \once\override TextScript #'extra-offset = #'(-4 . 1)
				b4^\markup\italic\smaller{"Всё тихо и довольно медленно"} e b b b a b e b b2 \J
