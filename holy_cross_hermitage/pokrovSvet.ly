...
\paper{head-separation = 0 between-system-padding=1 }
...
%            \override Score.SpacingSpanner #'shortest-duration-space = #1
                  ...
                  d4 b8([ c]) d4 e8([ d]) c2( b8[ c d e] c4) b c2 \W\break
                  e8([ f]) g4 f e e4.( d8) c([ d]) e4 d2 \J
                  d4( c8[ d] e4) d c2( b8[ c d e] c4 b) c2 \W
                  c4 d e e \Z e e8([ f e d]) c([ d]) e4 d2 \J
                  b4( c) d4( e8[ d] c2) b8([ c]) d4 c2 \W
                  d2 b4 c d2 c4( d) e8([ f e d]) \Z c([ d]) e4 d2 \J
                  d4. c8 d4 e f e d2 d4 e8([ d]) c2( b8[ c d e] c2)  b4 c8([ d]) c2 \W
                  e8([ f]) g4 f \Z e4.( d8) c([ d]) e4 d2 d4 d8([ c]) d([ e]) f4 e d b8([ c])  d4( e8[ d])
		...
		{ \override LyricText #'font-name = "Liberation Serif"
                ...
                и __ ны -- нѣ намъ, Го -- спо -- же, по -- сли ве -- ли -- ку -- ю тво -- ю __
                ми -- лость.
