...
\score{
\context ChoirStaff << \context Staff = top << \context Voice = firstTenor   
...
\context Staff = bass \relative c  { \clef"bass" \key f \major
	{ 
        f4 f8([ e]) d([ c]) f2 c4 c c c c d c f2 \J 
        f2 f4 f c2 c4 c f2 f4 c2 d4 \J 
        d8([ c]) bes4 bes bes bes8([ c]) d2 c \W 
        c4 d8([ c]) f4 f f  g f2 f4 f2 c4 c c c d c f2 \J 
        f8([ e]) d([ c]) f4.( g8 f[ c]) d4 bes c4 c2 d2 c \W 
        c8([ d]) e([ f]) f2 f4 d c2 f4 f8([ e]) f4 c2( f1)\fermata\bar"|." } }
>>
\include  "layout.ly"
\include "midi.ly"
}
