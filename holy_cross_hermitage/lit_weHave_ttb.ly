	...
	\context ChoirStaff <<
		\context Staff = top <<
			...
			{ \voiceTwo \global
                         ...
                         ges4 aes aes2( ees8[ f]) ges4 f8([ aes] g4 f4) ees2~ ees
		...
		\context Staff = bottom  \relative c
			{ \clef "bass" \global 
                \set Staff.midiInstrument = "cello"
                        bes'4 f des( bes ees) ges aes( ges bes f) bes,2 \J
                        des4 des ees8([ des]) c4 bes c( bes8[ des]) ees8([ des]) c4 bes2( ees) f \W
                        ges4 f c4( bes aes) aes aes2. aes2( g) \J
                        g!4( aes8[ bes] c4) des c bes aes aes aes2 aes4 aes aes2( ees'4) ees4 f2 \W
