...
\paper{ page-top-space=#2 bottom-margin=#8 }
...
\relative c' { \global\clef"G_8"
      ...
      g4( c2) a8([ bes]) c4( a2) a8([ g]) a([ bes]) c([ bes a bes]) c2 a8([ bes]) c4( bes8[ a]) g([ a]) bes4 a2 g \J 
      a8([ g a bes]) c4( bes8[ a] g4) a2 \J 
      g4  a8([ g]) bes([ c]) d4( c8[ bes] c4) bes a g8([ a] bes4) a2 \J 
      a8([ bes]) c4 bes8([ a]) \Z g4  a8([ bes]) c4.( bes8 c[ d]) c([ bes]) a([ g]) 
      a([ bes]) c4( a8[ g] a2 g8[ f] g2 f4 g8[ a]) g2\fermata\bar"||"
  
	}

\addlyrics { 

  Thou __ hast turned __ capt -- ive __ Si -- on 
  a -- way __ from de -- lu -- sion, 
  O __ Sav -- iour; Do Thou  
  en -- liv -- en me al -- so, a
  nd res -- cue __ me from  __ slav' -- ry __ to __ the pas -- sions.
...
\score{\relative c'{\global\clef"G_8"
    ...
    a4 a8([ g]) a2( bes4) c a8([ g]) f4 g2 a4 a8([ g]) bes8([ c bes a]) g4 f8([ g]) a4 g8([ a]) g4 \Z f2( g) \J a8([ bes])  c4 bes8([ a]) g4( a) bes c2 bes4 a8([ bes] c4 bes) bes8([ c]) d4( c8[ bes] c4 bes) a2  a4 g \Z a8([  g]) a([ bes]) c4( a8[ g] a2 g8[ f]) g2 f4( g8[ a] g2)\fermata\bar"||"
...
a8([ g]) a([ bes]) c4 bes a2 a8([ g]) a([ bes]) c4( bes) a g8([ bes]) bes[( g]) a2( g) \J a8([ g]) a([ bes]) \Z  c([ bes a bes]) c2 \J c bes4( c) d16([ c bes8 c bes)]  a4 bes8([ a]) g([ e]) f([ g]) a4 g8([ a]) g4 f2 g\fermata\bar"||"
