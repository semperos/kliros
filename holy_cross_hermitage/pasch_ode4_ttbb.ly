	...
	\context ChoirStaff <<
		\context Staff = top <<
			...
			{ \voiceOne \clef "G_8" \global \tempo 4=180
                                \partial 2 bes4^\markup\bold\italic{Heirmos:} 
                                ...
                                \partial 2 d4^\markup\bold\italic{Tropar 1} 
                                ...
                                d4^\markup\bold\italic{Tropar 2} d c d | ees2 d4 ees | f g f8([ ees]) d4 | ees2 d4 c |
                                ...
                                d2^\markup\bold\italic{Tropar 3} d4 d | c bes c d | ees2 d4 ees | f4 g f8([ ees]) d4 |
		...
		\context Lyrics \lyricsto "firstTenor"
		{
                        ...
                        Dav -- id, the an -- ces -- tor of God, leapt and dance be -- fore 
