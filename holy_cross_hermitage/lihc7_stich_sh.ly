...
\score {
\relative c'' {  \set Score.timing = ##f \key f \major \autoBeamOff \aikenHeads 
...
\addlyrics { 
	...
	and __ en -- light -- ened the __ hu -- man race and let __ us __ cry __ out with the in -- cor -- po -- rse -- al ones:
...
\score {
\relative c'' {  \set Score.timing = ##f \key f \major \autoBeamOff \aikenHeads 
	g4 f8([ g]) a2 g4 g8([ f]) g( a4 g8 f4)  g4 a2 a4 f8[( a]) g4 f2( g) \J g4 f g \Z a( bes8[ a]) g4 a8([ bes]) c4( a8[ g] a4)  g2  \J f4 a8([ bes]) c2 c4 bes c( bes a bes) c2 \J a8([ g]) a([ bes]) c4 \Z d16([ c bes8 c bes]) a2 a bes4( a) g2 \J g4 g f8([ g]) a4 f8([ a]) g4 f2( g) \J bes8([ a]) g4 a8([ bes]) \Z d4 a8([ g] a4 g2) f \fermata \bar"|." 
  	}
\addlyrics { 
