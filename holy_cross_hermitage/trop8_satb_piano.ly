...
sopline = \relative c''  { bes4 bes8[( c)]  d2( c4. bes8) a4 g a8[( bes)] c2 \W bes4.( a8) g[( e)] f[( g)] f( a2 g8[ f] g2) \Z f4 g8[( a)] g2 \fermata \W a8[( bes)] c4 a g bes8[( c)] d2( bes8[ c bes8. a16] g8) f( g4) g8[( a)] bes4( g8[ a]) g[( f)] \Z g2 f \J g4 a g a8[( g)] a[( bes)] c4 bes a g2( f8[ g] a2) g \fermata \breathe \W c4 g8[( bes)]  a[( g)] a[( bes)] \Z c4 bes8[( a)] bes8.([ c16 d8 c] bes d4. c8) bes4 bes8[( a)] bes8( c4 bes8 a[ bes] c4) bes8.[( a16 g8 bes)]   f( g4 a8) g[( f)] g2 \fermata \bar "|."   }

altline = \relative c'' { g4 g8[( a)] bes2( a4. f8) f4 e f a2 g2 e8[( c)] c[( e)] d8( f2 d4~ d2) d4 d e2 \W f4 a f e f bes2( f e!8) d( e4) e8[( f)] f4( e8[ f]) e[( d)] e2 c \J e4 f e  f8[( e)] f4 f f f d2(~ d4~ d2) e2 \fermata \W e4 e f8[( e)] f4 f f f( bes8[ a] f bes4. a8) f4 f f2(~ f4 a) f( e8[ f]) d2  e8[( d)] e2 \fermata }
...
\header { title = \markup \with-color #(rgb-color 0.8 0.1 0) 
			...
			subtitle = \markup \with-color #(x11-color 'navy) "Tone VIII"
