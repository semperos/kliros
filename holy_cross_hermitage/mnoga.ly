...
tick = \markup{ \with-color #(rgb-color 0.8 0.1 0) \bigger\bigger\bigger \raise #-1.3 * }
...
\tick Всечестнaго Настоsтелz Свzщенноархимандри1та ЛукY, \tick 
брaтiю свzты1z оби1тели сiS,
