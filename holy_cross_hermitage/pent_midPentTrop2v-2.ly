...
\score{
        ...
        bes4 bes8([ a]) bes( c4 bes8 a[ bes] c4) bes8.([ a16 g8 bes]) f8( g4 a8) g([ f]) g2\fermata\bar"|."
          ...
          \new Staff 
          { \clef "bass" \key f \major \set Staff.midiInstrument="voice oohs"
                
                f4 c2  c4~ c1~ c2  \J 
                c4 f f f f f f f2 \J
                f4 f c2. c4 c d2( f2) f4 c2 \W
                c4 c2 c4 c2 c4 c c f2 f4 f g2 \J
                g2 g4 g4. f8( g4) g8([ f]) e4( d) c4 c c d d e e8([ d]) c2( f) \W
                g2 f4 f ees2(~ f~ bes2) d,4 d g2 \J
                g4 g ees!2( f) d2 f f4 g2\fermata \bar"|."
