	...
	\context ChoirStaff <<
		\context Staff = top <<
			...
			d\breve^\markup\bold\italic{unhurriedly} d2 c4 d2 g1 \J 
                        ...
                        d\breve d2( c4) d4 bes1 \J
                        \repeat unfold 6 { bes4 } \Z c2 bes4 c d1 \W

                        d4 d d d2  d4 c d g1 \J
                        g\breve \hideNote f4 \Z f f ees ees d2 d1 \W
			...
			{ \voiceTwo \global
                        ...
                        \repeat unfold 6 { g4 } g2 g4 g f1

                        bes4 bes bes bes2 bes4 a bes bes1 
                        bes\breve s4 bes4 bes c c bes2 bes1
		...
		\context Lyrics \lyricsto "soprano"
		{
                        ...
                        Bless -- ed is the man that hop -- eth in Him.

                        O fear the Lord, all ye His saints,
                        \left "for there is" no want to them that fear him.
                        Rich men have turned poor and gone hun -- gry,
                        \left "but they that seek the Lord shall" not be de -- prived of an -- y 
		...
		\context Staff = bottom  \relative c'
                        ...
                        d\breve d2( f4) f f2( ees)
                        d4 c bes2 bes bes4 bes bes1

                        d\breve d2. d4 ees1
                        ees\breve f4 f f f d2 d1
                        d\breve d2( f) f2( ees)
                        d4 c bes\breve bes4 bes bes bes bes2 bes1
                        ...
                        d4 d d c bes4 bes bes2 bes4 bes bes1
                        
                        d4 d d d2 d4 d d ees1
                        ees\breve s4 f4 f f f d2 d1
                        d4 d d d d2 d4 d d2( f) bes,1
                        bes\breve \times 2/3 { bes4 bes bes } bes4 bes bes2( c4) bes c( bes2 c4) bes1\fermata
                        }
			...
			{ \clef "bass" \global \voiceTwo
                        ...
                        g\breve  f2( d4) d ees1 \J
                        \repeat unfold 6 { ees4 } ees2 d4 ees bes1 \W

                        g'4 g g g2 g4 g g ees1 \J
                        ees\breve s4 d4 d f f g2 g1 \W
                        g4 g g g g2 g4 g f2( d) ees1 \J
