...
\header { title = \markup\medium\smaller "“Rejoice in the Lord,"
          subtitle=\markup\medium\larger "O Ye Righteous”" 
...
\relative c'' { \key g \major \set Score.timing = ##f  \autoBeamOff \dottedPhrasingSlur 
        ...
        d2 c4 b8 c4  d4.\( c8\) b4 c4. b8 \Z a[ c] b4 c8.[ b16 a8 ] b2 a a4 b a8[ g])
		a4( b) c a8( c4 d8 c4 b c d e4.\( d8\) c4 d ) \Z c8( d4 e8) d[( b)] 
        c8( d2 c4 b8[ c d16 c b8] c4.\( b8\) a[ b] c4 d c b8[ c d8. c16 b8] c4 d2)  c8([ b]) \Z 
        c2( b) a8([ b c b]) a( c2 b4. c8 b4 a a-- b b2-- a8[ g]) a1 \fermata \bar "||"   
		d4( e) d( c) b8([ c d c] b4 c \Z d2 d4-- c8[ d] e4 d8[ c] b4 a2  c8\( d4 c8\) b4 a g a b c b8[ c] d4. c8 d4) 
        c4 c8([ b] a4 b a g \Z a b c2  d8[ c] b4 c2) \J
		d2 a4.( g8) a([ b] c4 b4.\( a8\) b\( c4 d8\) c4 b c8[ b] a4) g8([ a] b4) a2 \J
		b2( c4. b8 a[ b] c4 b a b c b8[ c] d4. e8 d4 c c8[-- b16 c d8 c] b2 a4 g a b a2 \Z  
