	...
	\context ChoirStaff \transpose c bes, << 
		\context Staff = top <<
			...
			{ \voiceOne \clef "G_8" \global
                                ...
                                e4^\markup\bold\italic{poco rit.} d8([ c]) d([ e]) f4 f8( e4 f8 d4 c) d2\fermata\bar"|."

			}
                              
			\context Voice = secondTenor \relative c'
			{ \voiceTwo \global
                                a4 a a2 a2 g4( c) c2 b2 
                                g4 c c8([ d]) e8([ d]) c4 c c2 b c 
                                b4 c c c c g a8([ g]) f([ g]) a4 g2 
                                b4 c c c8([ d]) e4 e d c c c2 b c 
                                g4 f4 g a a8( g4.~ g2)\> g2\!\p\fermata
			}
